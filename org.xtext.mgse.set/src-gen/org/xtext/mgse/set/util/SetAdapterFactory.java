 ...
 */
package org.xtext.mgse.set.util;
...
public class SetAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected SetSwitch<Adapter> modelSwitch =
    new SetSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseFORMS(FORMS object)
      {
        return createFORMSAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.xtext.mgse.set.PACK <em>PACK</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.xtext.mgse.set.PACKTYPE <em>PACKTYPE</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.xtext.mgse.set.FORMS <em>FORMS</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createFORMSAdapter()
  {
    return null;
  }

  /**
   * Creates a new adapter for an object of class '{@link org.xtext.mgse.set.URL <em>URL</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
