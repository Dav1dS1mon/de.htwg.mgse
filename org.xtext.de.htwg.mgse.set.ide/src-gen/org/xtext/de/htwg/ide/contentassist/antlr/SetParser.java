		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getEntityAccess().getGroup_3_0(), "rule__Entity__Group_3_0__0");
					...
					put(grammarAccess.getEntityAccess().getVisibilityAssignment_0(), "rule__Entity__VisibilityAssignment_0");
					put(grammarAccess.getEntityAccess().getNameAssignment_2(), "rule__Entity__NameAssignment_2");
					put(grammarAccess.getEntityAccess().getSuperTypeAssignment_3_0_1(), "rule__Entity__SuperTypeAssignment_3_0_1");
					put(grammarAccess.getEntityAccess().getSuperTypeAssignment_3_1_1(), "rule__Entity__SuperTypeAssignment_3_1_1");
